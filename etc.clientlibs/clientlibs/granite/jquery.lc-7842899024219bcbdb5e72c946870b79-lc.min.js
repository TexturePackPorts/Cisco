/*
 ...
 (function(m, S) {
    "object" === typeof module && "object" === typeof module.exports ? module.exports = m.document ? S(m, !0) : function(m) {
        if (!m.document)
    ...
    function ib() {
        p.addEventListener ? (p.removeEventListener("DOMContentLoaded", Y),
        m.removeEventListener("load", Y)) : (p.detachEvent("onreadystatechange", Y),
        m.detachEvent("onload", Y))
    }
    function Y() {
        if (p.addEventListener || "load" === m.event.type || "complete" === p.readyState)
            ib(),
            c.ready()
    }
    function jb(a, b, d) {
    ...
    function ob(a, b, d, e, f) {
        for (var g, h, l, k, n, r, t = a.length, m = nb(b), p = [], H = 0; H < t; H++)
            if ((h = a[H]) || 0 === h)
                if ("object" === c.type(h))
                    ...
                    if (!q.tbody)
                        for (g = (h = "table" !== k || qb.test(h) ? "\x3ctable\x3e" !== r[1] || qb.test(h) ? 0 : l : l.firstChild) && h.childNodes.length; g--; )
                            c.nodeName(n = h.childNodes[g], "tbody") && !n.childNodes.length && h.removeChild(n);
    ...
    function V(a, b, d, e) {
        b = xb.apply([], b);
        var f, g = 0, h = a.length, l = h - 1, k = b[0], n = c.isFunction(k);
        ...
        if (h) {
            ...
            if (t || e) {
                ...
                for (f = m.length; g < h; g++)
                    t = r,
                    g !== l && (t = c.clone(t, !0, !0),
                    f && c.merge(m, C(t, "script"))),
                    d.call(a[g], t, g);
                if (f)
                    for (r = m[m.length - 1].ownerDocument,
                    c.map(m, vb),
                    g = 0; g < f; g++)
                        t = m[g],
    ...
    function yb(a, b, d) {
        for (var e = b ? c.filter(b, a) : a, f = 0; null != (b = e[f]); f++)
            ...
            b.parentNode && (d && c.contains(b.ownerDocument, b) && Ma(C(b, "script")),
    ...
    function wa(a) {
        var b = p
          , d = Ab[a];
        d || (d = zb(a, b),
        "none" !== d && d || (ra = (ra || c("\x3ciframe frameborder\x3d'0' width\x3d'0' height\x3d'0'/\x3e")).appendTo(b.documentElement),
    ...
    function Eb(a, b) {
        for (var d, e, f, g = [], h = 0, l = a.length; h < l; h++)
            ...
            "" === e.style.display && xa(e) && (g[h] = c._data(e, "olddisplay", wa(e.nodeName)))) : (f = xa(e),
    ...
    function Gb(a, b, d, e, f) {
        ...
        for (var g = 0; 4 > b; b += 2)
            ...
            e ? ("content" === d && (g -= c.css(a, "padding" + ja[b], !0, f)),
            "margin" !== d && (g -= c.css(a, "border" + ja[b] + "Width", !0, f))) : (g += c.css(a, "padding" + ja[b], !0, f),
            "padding" !== d && (g += c.css(a, "border" + ja[b] + "Width", !0, f)));
        return g
    }
    function Hb(a, b, d) {
        var e = !0
    ...
    function Jb(a, b, c) {
        for (var d, f = (R.tweeners[b] || []).concat(R.tweeners["*"]), g = 0, h = f.length; g < h; g++)
            if (d = f[g].call(c, b, a))
                return d
    }
    function oc(a, b) {
    ...
    function R(a, b, d) {
        var e, f = 0, g = R.prefilters.length, h = c.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (e)
                return !1;
    ...
    function pc(a) {
        if (!c.contains(a.ownerDocument || p, a))
            return !0;
        for (; a && 1 === a.nodeType; ) {
    ...
    c.extend({
        ...
        isPlainObject: function(a) {
            ...
            if (!a || "object" !== c.type(a) || a.nodeType || c.isWindow(a))
                return !1;
            try {
                if (a.constructor && !ta.call(a, "constructor") && !ta.call(a.constructor.prototype, "isPrototypeOf"))
                    return !1
            } catch (d) {
                return !1
            }
        ...
        globalEval: function(a) {
            a && c.trim(a) && (m.execScript || function(a) {
                m.eval.call(m, a)
            }
            )(a)
        },
        ...
        makeArray: function(a, b) {
            b = b || [];
            null != a && (T(Object(a)) ? c.merge(b, "string" === typeof a ? [a] : a) : Wa.call(b, a));
            return b
        },
    ...
    var X = function(a) {
        function b(a, b, c, d) {
            var e, f, g, u, h = b && b.ownerDocument, y = b ? b.nodeType : 9;
            c = c || [];
            if ("string" !== typeof a || !a || 1 !== y && 9 !== y && 11 !== y)
                return c;
            if (!d && ((b ? b.ownerDocument || b : A) !== v && ya(b),
            b = b || v,
            aa)) {
                if (11 !== y && (u = ua.exec(a)))
                    if (e = u[1])
                        ...
                        if (u[2])
                            return w.apply(c, b.getElementsByTagName(a)),
                            c;
                        if ((e = u[3]) && G.getElementsByClassName && b.getElementsByClassName)
                            return w.apply(c, b.getElementsByClassName(e)),
                            c
                    }
                if (!(!G.qsa || M[a + " "] || O && O.test(a))) {
                    if (1 !== y) {
                        ...
                        (g = b.getAttribute("id")) ? g = g.replace(va, "\\$\x26") : b.setAttribute("id", g = z);
                        u = ha(a);
                        e = u.length;
                    ...
                    if (l)
                        try {
                            return w.apply(c, h.querySelectorAll(l)),
                            c
                        } catch (bd) {} finally {
        ...
        function E(a, c, d, f, g, h) {
            ...
            return e(function(e, h, u, y) {
                var l, k = [], n = [], W = h.length, L;
                if (!(L = e)) {
                    L = c || "*";
                    for (var r = u.nodeType ? [u] : u, m = [], t = 0, q = r.length; t < q; t++)
                        b(L, r[t], m);
                    L = m
                }
                ...
                if (e) {
                    if (g || a) {
                        ...
                        for (u = r.length; u--; )
                            (l = r[u]) && -1 < (p = g ? F(e, l) : k[u]) && (e[p] = !(h[p] = l))
                    }
                } else
                    r = C(r === h ? r.splice(W, r.length) : r),
                    g ? g(null, h, r, y) : w.apply(h, r)
            })
        }
        function P(a) {
            var b, c, d = a.length, e = B.relative[a[0].type];
            var f = e || B.relative[" "];
            for (var g = e ? 1 : 0, h = p(function(a) {
                return a === b
            }, f, !0), u = p(function(a) {
                return -1 < F(b, a)
                ...
                if (f = B.relative[a[g].type])
                    ...
                    if (f[z]) {
                        for (c = ++g; c < d && !B.relative[a[c].type]; c++)
                            ;
                        return E(1 < g && H(l), 1 < g && q(a.slice(0, g - 1).concat({
                            value: " " === a[g - 2].type ? "*" : ""
                        })).replace(V, "$1"), f, g < c && P(a.slice(g, c)), c < d && P(a = a.slice(c)), c < d && q(a))
                    }
                    l.push(f)
                }
            return H(l)
        ...
        function I(a, c) {
            var d = 0 < c.length
              ...
              , g = function(e, g, h, u, l) {
                var y, k, n = 0, W = "0", L = e && [], r = [], m = N, t = e || f && B.find.TAG("*", l), p = ma += null == m ? 1 : Math.random() || .1, q = t.length;
                for (l && (N = g === v || g || l); W !== q && null != (y = t[W]); W++) {
                    if (f && y) {
                        var Xa = 0;
                        g || y.ownerDocument === v || (ya(y),
                        h = !aa);
                        for (; k = a[Xa++]; )
                            if (k(y, g || v, h)) {
                                u.push(y);
        ...
        var x, N, J, Q, v, ba, aa, O, za, Ea, Ba, z = "sizzle" + 1 * new Date, A = a.document, ma = 0, S = 0, R = c(), T = c(), M = c(), K = function(a, b) {
            a === b && (Q = !0);
            return 0
        }, U = {}.hasOwnProperty, D = [], ca = D.pop, da = D.push, w = D.push, Y = D.slice, F = function(a, b) {
        ...
        }, sa = /^(?:input|select|textarea|button)$/i, ta = /^h\d$/i, X = /^[^{]+\{\s*\[native \w/, ua = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, fa = /[+~]/, va = /'|\\/g, na = /\\([\da-f]{1,6}[\x20\t\r\n\f]?|([\x20\t\r\n\f])|.)/ig, oa = function(a, b, c) {
            a = "0x" + b - 65536;
        ...
        var ya = b.setDocument = function(a) {
            ...
            aa = !xa(v);
            (b = v.defaultView) && b.top !== b && (b.addEventListener ? b.addEventListener("unload", ra, !1) : b.attachEvent && b.attachEvent("onunload", ra));
            ...
            G.getById ? (B.find.ID = function(a, b) {
            ...
            B.find.TAG = G.getElementsByTagName ? function(a, b) {
            ...
            ;
            B.find.CLASS = G.getElementsByClassName && function(a, b) {
            ...
            if (G.qsa = X.test(v.querySelectorAll))
                f(function(a) {
                    ba.appendChild(a).innerHTML = "\x3ca id\x3d'" + z + "'\x3e\x3c/a\x3e\x3cselect id\x3d'" + z + "-\r\\' msallowcapture\x3d''\x3e\x3coption selected\x3d''\x3e\x3c/option\x3e\x3c/select\x3e";
            ...
            (G.matchesSelector = X.test(Ea = ba.matches || ba.webkitMatchesSelector || ba.mozMatchesSelector || ba.oMatchesSelector || ba.msMatchesSelector)) && f(function(a) {
            ...
            Ba = (b = X.test(ba.compareDocumentPosition)) || X.test(ba.contains) ? function(a, b) {
            ...
            K = b ? function(a, b) {
                ...
                return c & 1 || !G.sortDetached && b.compareDocumentPosition(a) === c ? a === v || a.ownerDocument === A && Ba(A, a) ? -1 : b === v || b.ownerDocument === A && Ba(A, b) ? 1 : J ? F(J, a) - F(J, b) : 0 : c & 4 ? -1 : 1
            }
            : function(a, b) {
                if (a === b)
                    return Q = !0,
                ...
                var c = 0
                  ...
                  , g = [b];
                if (!d || !e)
                    return a === v ? -1 : b === v ? 1 : d ? -1 : e ? 1 : J ? F(J, a) - F(J, b) : 0;
                if (d === e)
                    return h(a, b);
                for (; a = a.parentNode; )
                    f.unshift(a);
        ...
        b.matchesSelector = function(a, c) {
            ...
            if (!(!G.matchesSelector || !aa || M[c + " "] || za && za.test(c) || O && O.test(c)))
                try {
                    var d = Ea.call(a, c);
        ...
        b.attr = function(a, b) {
            ...
            return void 0 !== c ? c : G.attributes || !aa ? a.getAttribute(b) : (c = a.getAttributeNode(b)) && c.specified ? c.value : null
        }
        ;
        b.error = function(a) {
        ...
        var B = b.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(a) {
                    ...
                    if (Z.CHILD.test(a[0]))
                        return null;
                    a[3] ? a[2] = a[4] || a[5] || "" : c && pa.test(c) && (b = ha(c, !0)) && (b = c.indexOf(")", c.length - b) - c.length) && (a[0] = a[0].slice(0, b),
                    a[2] = c.slice(0, b));
                    return a.slice(0, 3)
                }
            },
                    ...
                    : function(b, c, l) {
                        ...
                        if (u) {
                            ...
                            if (g && l) {
                                ...
                                m = t[a] || [];
                                m = (n = m[0] === ma && m[1]) && m[2];
                                for (k = n && u.childNodes[n]; k = ++n && k && k[c] || (m = n = 0) || y.pop(); )
                            ...
                            m = n = m[0] === ma && m[1]),
                            !1 === m)
                                for (; (k = ++n && k && k[c] || (m = n = 0) || y.pop()) && ((h ? k.nodeName.toLowerCase() !== r : 1 !== k.nodeType) || !++m || (l && (t = k[z] || (k[z] = {}),
                                t = t[k.uniqueID] || (t[k.uniqueID] = {}),
                                t[a] = [ma, m]),
                                k !== b)); )
                                    ;
            ...
            pseudos: {
                ...
                lang: e(function(a) {
                    ...
                    return function(b) {
                        var c;
                        do
                            if (c = aa ? b.lang : b.getAttribute("xml:lang") || b.getAttribute("lang"))
        ...
        var ha = b.tokenize = function(a, c) {
            ...
            for (h = B.preFilter; g; ) {
                ...
                if (d = ka.exec(g))
                    ...
                    g = g.slice(k.length);
                for (f in B.filter)
                    !(d = Z[f].exec(g)) || h[f] && !(d = h[f](d)) || (k = d.shift(),
                    e.push({
                        value: k,
                        type: f,
                        matches: d
        ...
        var Aa = b.select = function(a, b, c, d) {
            var e, f, g, h = "function" === typeof a && a, l = !d && ha(a = h.selector || a);
            c = c || [];
            if (1 === l.length) {
                var k = l[0] = l[0].slice(0);
                if (2 < k.length && "ID" === (f = k[0]).type && G.getById && 9 === b.nodeType && aa && B.relative[k[1].type]) {
                ...
                for (e = Z.needsContext.test(a) ? 0 : k.length; e--; ) {
                    ...
                    if (B.relative[g = f.type])
                        break;
                    if (g = B.find[g])
                        if (d = g(f.matches[0].replace(na, oa), fa.test(k[0].type) && r(b.parentNode) || b)) {
                            k.splice(e, 1);
                            a = d.length && q(k);
                            if (!a)
                                return w.apply(c, d),
    ...
    c.fn.extend({
        ...
        is: function(a) {
            return !!da(this, "string" === typeof a && Qb.test(a) ? c(a) : a || [], !1).length
        }
    });
    var xc = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
    (c.fn.init = function(a, b, d) {
        ...
        d = d || Sb;
        if ("string" === typeof a) {
            var e = "\x3c" === a.charAt(0) && "\x3e" === a.charAt(a.length - 1) && 3 <= a.length ? [null, a, null] : xc.exec(a);
            if (!e || !e[1] && b)
    ...
    c.each({
        ...
        c.fn[a] = function(d, e) {
            ...
            1 < this.length && (zc[a] || (f = c.uniqueSort(f)),
            yc.test(a) && (f = f.reverse()));
            ...
            add: function() {
                ...
                function Oa(b) {
                    c.each(b, function(b, d) {
                        c.isFunction(d) ? a.unique && n.has(d) || g.push(d) : d && d.length && "string" !== c.type(d) && Oa(d)
                    })
                }(arguments),
                d && !b && k());
                return this
    ...
    c.extend({
        ...
        when: function(a) {
            var b = 0, d = F.call(arguments), e = d.length, f = 1 !== e || a && c.isFunction(a.promise) ? e : 0, g = 1 === f ? a : c.Deferred(), h = function(a, b, c) {
                return function(d) {
                    b[a] = this;
            ...
            if (1 < e) {
                ...
                var n = Array(e);
                for (l = Array(e); b < e; b++)
                    d[b] && c.isFunction(d[b].promise) ? d[b].promise().progress(h(b, n, k)).done(h(b, l, d)).fail(g.reject) : --f
            }
            f || g.resolveWith(l, d);
            return g.promise()
        }
    ...
    c.extend({
        ...
        ready: function(a) {
            ...
            !0 !== a && 0 < --c.readyWait || (Fa.resolveWith(p, [c]),
            c.fn.triggerHandler && (c(p).triggerHandler("ready"),
            c(p).off("ready"))))
        }
    });
    c.ready.promise = function(a) {
        if (!Fa)
            if (Fa = c.Deferred(),
            "complete" === p.readyState || "loading" !== p.readyState && !p.documentElement.doScroll)
    ...
    (function() {
        ...
        q.html5Clone = "\x3c:nav\x3e\x3c/:nav\x3e" !== p.createElement("nav").cloneNode(!0).outerHTML;
        d.type = "checkbox";
        d.checked = !0;
        b.appendChild(d);
    ...
    I.th = I.td;
    q.option || (I.optgroup = I.option = [1, "\x3cselect multiple\x3d'multiple'\x3e", "\x3c/select\x3e"]);
    var jc = /<|&#?\w+;/
      , qb = /<tbody/i;
    (function() {
        var a, b = p.createElement("div");
        for (a in {
            submit: !0,
            change: !0,
            focusin: !0
    ...
    c.event = {
        ...
        add: function(a, b, d, e, f) {
            ...
            if (h = c._data(a)) {
                ...
                for (h = b.length; h--; ) {
                    ...
                    (n = g[p]) || (n = g[p] = [],
                    n.delegateCount = 0,
                    t.setup && !1 !== t.setup.call(a, e, q, l) || (a.addEventListener ? a.addEventListener(p, l, !1) : a.attachEvent && a.attachEvent("on" + p, l))),
                    t.add && (t.add.call(a, k),
        ...
        remove: function(a, b, d, e, f) {
            var g, h, l, k, n, m = c.hasData(a) && c._data(a);
            if (m && (k = m.events)) {
                b = (b || "").match(U) || [""];
                for (l = b.length; l--; ) {
                    var p = Ub.exec(b[l]) || [];
                    ...
                    if (q) {
                        ...
                        var E = k[q] || [];
                        p = p[2] && new RegExp("(^|\\.)" + C.join("\\.(?:.*\\.|)") + "(\\.|$)");
                        for (h = g = E.length; g--; ) {
                            var w = E[g];
                            !f && n !== w.origType || d && d.guid !== w.guid || p && !p.test(w.namespace) || e && e !== w.selector && ("**" !== e || !w.selector) || (E.splice(g, 1),
                            w.selector && E.delegateCount--,
                            H.remove && H.remove.call(a, w))
                        }
                        h && !E.length && (H.teardown && !1 !== H.teardown.call(a, C, m.handle) || c.removeEvent(a, q, m.handle),
                        delete k[q])
                    } else
                        for (q in k)
                            c.event.remove(a, q + b[l], d, e, !0)
                }
                c.isEmptyObject(k) && (delete m.handle,
                c._removeData(a, "events"))
            }
        },
        trigger: function(a, b, d, e) {
            var f, g, h = [d || p], l = ta.call(a, "type") ? a.type : a;
                ...
                if (e || !k.trigger || !1 !== k.trigger.apply(d, b)) {
                    if (!e && !k.noBubble && !c.isWindow(d)) {
                        ...
                        for (; n; n = n.parentNode)
                            h.push(n),
                            f = n;
                        f === (d.ownerDocument || p) && h.push(f.defaultView || f.parentWindow || m)
                    }
                    for (g = 0; (n = h[g++]) && !a.isPropagationStopped(); )
                        a.type = 1 < g ? q : k.bindType || l,
                        (f = (c._data(n, "events") || {})[a.type] && c._data(n, "handle")) && f.apply(n, b),
                        (f = r && n[r]) && f.apply && va(n) && (a.result = f.apply(n, b),
                        !1 === a.result && a.preventDefault());
                    a.type = l;
                    if (!(e || a.isDefaultPrevented() || k._default && !1 !== k._default.apply(h.pop(), b)) && va(d) && r && d[l] && !c.isWindow(d)) {
                        (f = d[r]) && (d[r] = null);
                        c.event.triggered = l;
                        try {
                            d[l]()
        ...
        fix: function(a) {
            ...
            var d = a
              , e = this.fixHooks[b];
            e || (this.fixHooks[b] = e = Cc.test(b) ? this.mouseHooks : Bc.test(b) ? this.keyHooks : {});
    ...
    c.Event = function(a, b) {
        ...
        this.type = a.type,
        this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && !1 === a.returnValue ? ha : ia) : this.type = a;
        b && c.extend(this, b);
    ...
    c.extend({
                    ...
                    if (l[f]) {
                        ...
                        if (1 === p.nodeType) {
                            ...
                            if ("script" === w && p.text !== m.text)
                                ...
                                q.html5Clone && m.innerHTML && !c.trim(p.innerHTML) && (p.innerHTML = m.innerHTML);
        ...
        cleanData: function(a, b) {
            for (var d, e, f, g, h = 0, l = c.expando, k = c.cache, n = q.attributes, m = c.event.special; null != (d = a[h]); h++)
                if (b || va(d))
                    if (g = (f = d[l]) && k[f]) {
                        if (g.events)
                            for (e in g.events)
                        ...
                        k[f] && (delete k[f],
                        n || "undefined" === typeof d.removeAttribute ? d[l] = void 0 : d.removeAttribute(l),
                        D.push(f))
                    }
        }
    });
    c.fn.extend({
        ...
        html: function(a) {
            return ea(this, function(a) {
                ...
                if (!("string" !== typeof a || Ec.test(a) || !q.htmlSerialize && Vb.test(a) || !q.leadingWhitespace && Pa.test(a) || I[(pb.exec(a) || ["", ""])[1].toLowerCase()])) {
                    a = c.htmlPrefilter(a);
                    try {
                        for (; e < f; e++)
                            b = this[e] || {},
                            1 === b.nodeType && (c.cleanData(C(b, !1)),
                            b.innerHTML = a);
                        b = 0
                    } catch (g) {}
                }
        ...
        replaceWith: function() {
            ...
            return V(this, arguments, function(b) {
                ...
                0 > c.inArray(this, a) && (c.cleanData(C(this)),
    ...
    var ra, Ab = {
        HTML: "block",
        BODY: "block"
    }, Wb = /^margin/, Aa = new RegExp("^(" + Ya + ")(?!px)[a-z%]+$","i"), ab = function(a, b, c, e) {
        var d, g = {};
        for (d in b)
            g[d] = a.style[d],
            a.style[d] = b[d];
    ...
    (function() {
        ...
        var b, d, e, f, g, h, l = p.createElement("div"), k = p.createElement("div");
    ...
    c.extend({
        ...
        style: function(a, b, d, e) {
            if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                ...
                if (void 0 !== d) {
                    var k = typeof d;
                    "string" === k && (f = La.exec(d)) && f[1] && (d = mb(a, b, f),
                    k = "number");
    ...
    c.each(["height", "width"], function(a, b) {
        c.cssHooks[b] = {
            get: function(a, e, f) {
                if (e)
                    return Hc.test(c.css(a, "display")) && 0 === a.offsetWidth ? ab(a, Ic, function() {
                        return Hb(a, b, f)
                    }) : Hb(a, b, f)
            },
            set: function(a, e, f) {
    ...
    c.cssHooks.marginLeft = Ra(q.reliableMarginLeft, function(a, b) {
        if (b)
            return (parseFloat(ka(a, "marginLeft")) || (c.contains(a.ownerDocument, a) ? a.getBoundingClientRect().left - ab(a, {
                marginLeft: 0
            }, function() {
    ...
    c.fx.step = {};
    var sa, Ga, Jc = /^(?:toggle|show|hide)$/, Kc = /queueHooks$/;
    c.Animation = c.extend(R, {
        ...
        prefilters: [function(a, b, d) {
            var e, f = this, g = {}, h = a.style, l = a.nodeType && xa(a), k = c._data(a, "fxshow");
            if (!d.queue) {
            ...
            if (1 === a.nodeType && ("height"in b || "width"in b)) {
                ...
                "inline" === w && "none" === c.css(a, "float") && (q.inlineBlockNeedsLayout && "inline" !== wa(a.nodeName) ? h.zoom = 1 : h.display = "inline-block")
            }
    ...
    c.extend({
        ...
        removeAttr: function(a, b) {
            ...
            if (e && 1 === a.nodeType)
                for (; b = e[d++]; ) {
                    var f = c.propFix[b] || b;
                    c.expr.match.bool.test(b) ? Ha && pa || !cb.test(b) ? a[f] = !1 : a[c.camelCase("default-" + b)] = a[f] = !1 : c.attr(a, b, "");
    ...
    var Nc = {
        set: function(a, b, d) {
            !1 === b ? c.removeAttr(a, d) : Ha && pa || !cb.test(d) ? a.setAttribute(!pa && c.propFix[d] || d, d) : a[c.camelCase("default-" + d)] = a[d] = !0;
            return d
        }
    };
    c.each(c.expr.match.bool.source.match(/\w+/g), function(a, b) {
        var d = ca[b] || c.find.attr;
        Ha && pa || !cb.test(b) ? ca[b] = function(a, b, c) {
            if (!c) {
                var e = ca[b];
                ca[b] = f;
    ...
    Ha && pa || (c.attrHooks.value = {
        set: function(a, b, d) {
            if (c.nodeName(a, "input"))
                a.defaultValue = b;
            else
                return qa && qa.set(a, b, d)
        }
    });
    if (!pa) {
        var qa = {
        ...
        ca.id = ca.name = ca.coords = function(a, b, c) {
            var d;
            if (!c)
    ...
    c.fn.extend({
        ...
        toggleClass: function(a, b) {
            ...
            return "boolean" === typeof b && "string" === d ? b ? this.addClass(a) : this.removeClass(a) : c.isFunction(a) ? this.each(function(d) {
                ...
                if ("string" === d) {
                    ...
                    (b = la(this)) && c._data(this, "__className__", b),
        ...
        hasClass: function(a) {
            var b, c = 0;
            for (a = " " + a + " "; b = this[c++]; )
                if (1 === b.nodeType && -1 < (" " + la(b) + " ").replace(db, " ").indexOf(a))
                    return !0;
            return !1
        }
    });
    ...
    c.parseJSON = function(a) {
        ...
        return e && !c.trim(e.replace(Rc, function(a, c, e, l) {
            b && c && (d = 0);
            if (0 === d)
                return a;
            b = e || c;
        ...
        ajax: function(a, b) {
            function d(a, b, d, e) {
                ...
                if (2 !== P) {
                    ...
                    if (d) {
                        var r = n;
                        for (var t = x, v, J, z, A, D = r.contents, Q = r.dataTypes; "*" === Q[0]; )
                            Q.shift(),
                            void 0 === J && (J = r.mimeType || t.getResponseHeader("Content-Type"));
                        if (J)
                            for (A in D)
                                if (D[A] && D[A].test(J)) {
                                    Q.unshift(A);
                                    ...
                                    if (!0 !== M)
                                        if (M && d["throws"])
                                            ...
                                            try {
                                                ...
                                                r = {
                                                    state: "parsererror",
                                                    error: M ? wc : "No conversion from " + K + " to " + A
                                                };
                                                break a
                                            }
                                }
                    ...
                    if (e)
                        if (n.ifModified && ((k = x.getResponseHeader("Last-Modified")) && (c.lastModified[N] = k),
            ...
            a = void 0);
            b = b || {};
            var e, f, g, h, l, k, n = c.ajaxSetup({}, b), p = n.context || n, q = n.context && (p.nodeType || p.jquery) ? c(p) : c.event, w = c.Deferred(), C = c.Callbacks("once memory"), E = n.statusCode || {}, D = {}, F = {}, P = 0, K = "canceled", x = {
                readyState: 0,
            ...
            x.success = x.done;
            x.error = x.fail;
            n.url = ((a || n.url || gb) + "").replace(Sc, "").replace(Vc, fa[1] + "//");
            n.type = b.method || b.type || n.method || n.type;
            n.dataTypes = c.trim(n.dataType || "*").toLowerCase().match(U) || [""];
            null == n.crossDomain && (a = $b.exec(n.url.toLowerCase()),
            n.crossDomain = !(!a || a[1] === fa[1] && a[2] === fa[2] && (a[3] || ("http:" === a[1] ? "80" : "443")) === (fa[3] || ("http:" === fa[1] ? "80" : "443"))));
            n.data && n.processData && "string" !== typeof n.data && (n.data = c.param(n.data, n.traditional));
            Lb(ac, n, b, x);
            if (2 === P)
                return x;
            (h = c.event && n.global) && 0 === c.active++ && c.event.trigger("ajaxStart");
            n.type = n.type.toUpperCase();
            n.hasContent = !Uc.test(n.type);
            var N = n.url;
            n.hasContent || (n.data && (N = n.url += (fb.test(N) ? "\x26" : "?") + n.data,
            delete n.data),
            !1 === n.cache && (n.url = Zb.test(N) ? N.replace(Zb, "$1_\x3d" + eb++) : N + (fb.test(N) ? "\x26" : "?") + "_\x3d" + eb++));
            n.ifModified && (c.lastModified[N] && x.setRequestHeader("If-Modified-Since", c.lastModified[N]),
            ...
            x.setRequestHeader("Accept", n.dataTypes[0] && n.accepts[n.dataTypes[0]] ? n.accepts[n.dataTypes[0]] + ("*" !== n.dataTypes[0] ? ", " + bc + "; q\x3d0.01" : "") : n.accepts["*"]);
            for (e in n.headers)
                x.setRequestHeader(e, n.headers[e]);
            ...
            if (l = Lb(Sa, n, b, x)) {
                ...
                if (2 === P)
                    return x;
                n.async && 0 < n.timeout && (g = m.setTimeout(function() {
                    x.abort("timeout")
                }, n.timeout));
                try {
                    P = 1,
    ...
    c.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var a = this.type;
                return this.name && !c(this).is(":disabled") && Yc.test(this.nodeName) && !Xc.test(a) && (this.checked || !Na.test(a))
            }).map(function(a, b) {
                a = c(this).val();
    ...
    c.ajaxSettings.xhr = void 0 !== m.ActiveXObject ? function() {
        return this.isLocal ? Mb() : 8 < p.documentMode ? Va() : /^(get|post|head|put|delete|options)$/i.test(this.type) && Va() || Mb()
    }
    : Va;
    var Zc = 0
      , Ia = {}
        ...
        if (!a.crossDomain || q.cors) {
            ...
            return {
                send: function(d, e) {
                    ...
                    ;
                    a.async ? 4 === g.readyState ? m.setTimeout(b) : g.onreadystatechange = Ia[h] = b : b()
                },
                abort: function() {
                    b && b(void 0, !0)
                }
...
!function(m) {
    ...
    if (3 <= Number(m.fn.jquery.split(".")[0]))
        return void (window.console && window.console.warn && window.console.warn("The jquery.requestanimationframe plugin is not needed in jQuery 3.0 or newer as they handle it natively."));
    var T;
    window.requestAnimationFrame && (m.fx.timer = function(da) {
        da() && m.timers.push(da) && !T && (T = !0,
        S())
    }
    ,
    m.fx.stop = function() {
...
(function(m) {
    ...
    m.htmlPrefilter = function(m) {
        ...
        w !== m && S(m) !== S(w) && console.error("HTML tags must be properly nested and closed: " + m);
        return da(m)
    }
}
)(window.jQuery);
