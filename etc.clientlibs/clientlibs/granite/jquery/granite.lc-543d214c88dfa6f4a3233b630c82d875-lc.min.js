(function(f, d) {
    ...
    f.ajaxSetup({
        ...
        beforeSend: function(d, c) {
            "undefined" !== typeof G_IS_HOOKED && G_IS_HOOKED(c.url) || (c.externalize && (c.url = g.externalize(c.url)),
            c.encodePath && (c.url = g.encodePathOfURI(c.url)));
            c.hook && (d = g.getXhrHook(c.url, c.type, c.data)) && (c.url = d.url,
            d.params && ("GET" === c.type.toUpperCase() ? c.url += "?" + f.param(d.params) : c.data = f.param(d.params)))
        },
        statusCode: {
            403: function(d) {
                "Authentication Failed" === d.getResponseHeader("X-Reason") && g.handleLoginRedirect()
            }
        }
    });
...
(function(f) {
    ...
    function c() {
        ...
        b.onreadystatechange = function() {
            if (4 === b.readyState)
                try {
                    e = JSON.parse(b.responseText).token,
                    a.resolve(e)
                } catch (r) {
                    k(r),
    ...
    function p(a) {
        ...
        "GET" === a.method.toUpperCase() || b && !g(b) || (e || n(),
        e && (b = a.querySelector('input[name\x3d":cq_csrf_token"]'),
    ...
    var m = f.externalize("/libs/granite/csrf/token.json"), l, e;
    q(document);
    var t = XMLHttpRequest.prototype.open;
    XMLHttpRequest.prototype.open = function(a, b, c) {
        "get" !== a.toLowerCase() && g(b) && (this._csrf = !0,
        this._async = c);
    ...
    XMLHttpRequest.prototype.send = function() {
        if (this._csrf)
            if (e)
                this.setRequestHeader("CSRF-Token", e),
    ...
    if (window.Node) {
        ...
        Node.prototype.appendChild = function() {
            ...
            if ("IFRAME" === a.nodeName)
                try {
                    a.contentWindow && !a._csrf && (a._csrf = !0,
