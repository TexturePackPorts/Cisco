    ...
    return {
        ...
        applyDefaults: function() {
            for (var a, e = arguments[0] || {}, c = 1; c < arguments.length; c++) {
                ...
                for (var f in a) {
                    var g = a[f];
                    a.hasOwnProperty(f) && void 0 !== g && (e[f] = null === g || "object" !== typeof g || g instanceof Array ? g instanceof Array ? g.slice(0) : g : this.applyDefaults(e[f], g))
                }
            }
            return e
        },
...
(function(a) {
    ...
    return function() {
        var c = null
          , f = /^(?:http|https):\/\/[^/]+(\/.*)\/(?:etc\.clientlibs|etc(\/.*)*\/clientlibs|libs(\/.*)*\/clientlibs|apps(\/.*)*\/clientlibs|etc\/designs).*\.js(\?.*)?$/
          , g = /[^\w-.~%:/?[\]@!$&'()*+,;=]/
          , l = /^(([^:/?#]+):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/
          , k = !1
          , d = {
            ...
            externalize: function(b) {
                try {
                    0 === b.indexOf("/") && d.getContextPath() && 0 !== b.indexOf(d.getContextPath() + "/") && (b = d.getContextPath() + b)
                } catch (m) {}
                return b
            },
            internalize: function(b, a) {
                if ("/" === b.charAt(0))
                    return c === b ? "" : c && 0 === b.indexOf(c + "/") ? b.substring(c.length) : b;
                a || (a = document);
            ...
            handleLoginRedirect: function() {
                if (!k) {
                    ...
                    b.href = d.externalize("/") + "?resource\x3d" + encodeURIComponent(b.pathname + b.search + b.hash)
                }
            },
    ...
    return function() {
        var e = {}
          ...
          , m = function(a) {
            if (b)
                return c + a + f;
            var h, d = document.querySelector("html");
            d && (h = d.getAttribute("data-i18n-dictionary-src"));
            return h ? h.replace("{locale}", encodeURIComponent(a)).replace("{+locale}", a) : c + a + f
        };
        d.LOCALE_DEFAULT = "en";
        ...
        d.getLanguages = function() {
            if (!k)
                try {
                    var b = a.externalize("/libs/wcm/core/resources/languages.overlay.infinity.json")
                    ...
                    Object.keys(e).forEach(function(a) {
                        ...
                        a.title && a.country && "*" !== a.country && (a.title += " (" + d.getVar(a.country) + ")")
                    });
                    k = e
                } catch (q) {
                    k = {}
    ...
    return function() {
        ...
        a.isOptedOut = function() {
            for (var c = document.cookie.split(";"), e = 0; e < c.length; e++) {
                ...
                f = String.prototype.trim ? f.trim() : f.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
                if (0 <= a.getCookieNames().indexOf(f))
                    return !0
            }
            return !1
        }
...
(function(a) {
    "object" === typeof module && module.exports ? module.exports = a() : (window.Granite = window.Granite || {}).Toggles = a()
}
)(function() {
    var a = null;
    return {
        isEnabled: function(e) {
            var c;
            (c = a) || (c = new XMLHttpRequest,
            c.open("GET", Granite.HTTP.externalize("/etc.clientlibs/toggles.json"), !1),
            c.send(null),
